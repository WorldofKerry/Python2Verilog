...
@pytest.mark.usefixtures("argparse")
class Opti0(BaseTestCases.BaseTest, GraphBase):
    def __init__(self, *args, **kwargs):
        GraphBase.__init__(self, optimization_level=int(self.__class__.__name__[-1]))
        BaseTestCases.BaseTest.__init__(self, *args, **kwargs)


@pytest.mark.usefixtures("argparse")
class Opti1(BaseTestCases.BaseTest, GraphBase):
    def __init__(self, *args, **kwargs):
        GraphBase.__init__(self, optimization_level=int(self.__class__.__name__[-1]))
        BaseTestCases.BaseTest.__init__(self, *args, **kwargs)
...
@pytest.mark.usefixtures("argparse")
class Opti2(BaseTestCases.BaseTest, GraphBase):
    def __init__(self, *args, **kwargs):
        GraphBase.__init__(self, optimization_level=int(self.__class__.__name__[-1]))
        BaseTestCases.BaseTest.__init__(self, *args, **kwargs)
...
@pytest.mark.usefixtures("argparse")
class Opti3(BaseTestCases.BaseTest, GraphBase):
    def __init__(self, *args, **kwargs):
        GraphBase.__init__(self, optimization_level=int(self.__class__.__name__[-1]))
        BaseTestCases.BaseTest.__init__(self, *args, **kwargs)
