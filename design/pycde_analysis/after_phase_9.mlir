// passes ran: builtin.module(lower-seq-to-sv)
module {
  ...
  hw.module @F0(%in0: i1, %in1: i1, %in2: i1, %clk: i1, %rst: i1) -> (out0: i1, out1: i1, out2: i1, out3: i1) {
    ...
    %16 = comb.xor bin %in1, %true_18 : i1
