...
class GeneratorParser:
    ...
    @staticmethod
    def generate_return_vars(node: ast.AST, prefix: str) -> list[str]:
        """
    ...
    def add_global_var(self, initial_value: str, name: str) -> str:
        """
    ...
    @staticmethod
    def stringify_global_var_decl(global_vars) -> Lines:
        """
        reg [31:0] <name>
    ...
    @staticmethod
    def stringify_always_block() -> tuple[Lines, Lines]:
        """
    ...
    def generate_verilog(self, indent: int = 0) -> Lines:
        """
